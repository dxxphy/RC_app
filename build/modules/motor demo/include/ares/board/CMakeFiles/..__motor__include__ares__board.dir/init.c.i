...
static const struct pwm_dt_spec pwm_led_r = { .dev = (&__device_dts_ord_57), .channel = 3, .period = 20000000, .flags = 0, };
static const struct pwm_dt_spec pwm_led_g = { .dev = (&__device_dts_ord_57), .channel = 2, .period = 20000000, .flags = 0, };
static const struct pwm_dt_spec pwm_led_b = { .dev = (&__device_dts_ord_57), .channel = 1, .period = 20000000, .flags = 0, };
