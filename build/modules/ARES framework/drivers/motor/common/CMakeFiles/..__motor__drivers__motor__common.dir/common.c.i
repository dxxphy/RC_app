# 0 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
...
# 0 "<command-line>" 2
# 1 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
...
# 2 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 2
...
# 22 "/home/librgod/zephyr_workspace/zephyr/include/zephyr/kernel_includes.h" 2
...
# 24 "/home/librgod/zephyr_workspace/zephyr/include/zephyr/kernel_includes.h" 2
...
# 19 "/home/librgod/zephyr_workspace/zephyr/include/zephyr/sys/atomic.h" 2
...
# 3 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 2
...
# 5 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 2
...
# 6 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 2


const 
# 8 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
__attribute__((__aligned__(
# 8 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
__alignof(struct log_source_const_data)
# 8 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
))) 
# 8 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
struct log_source_const_data log_const_motor_common __attribute__((section("." "_log_const" "." "static" "." "log_const_motor_common_"))) __attribute__((__used__)) = { .name = "motor_common", .level = (4) }; extern const struct log_source_const_data log_const_motor_common; extern struct log_source_dynamic_data log_dynamic_motor_common; static const struct log_source_const_data * __log_current_const_data __attribute__((__unused__)) = 1 ? &log_const_motor_common : 
# 8 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
((void *)0)
# 8 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
; static struct log_source_dynamic_data * __log_current_dynamic_data __attribute__((__unused__)) = (1 && 0) ? &log_dynamic_motor_common : 
# 8 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
((void *)0)
# 8 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
; static const uint32_t __log_level __attribute__((__unused__)) = 4;

# 1 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.h" 1
...
# 11 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 2

static struct k_sem tx_queue_sem[2];
static struct device *can_devices[2];

static char __attribute__((section("." "noinit" "." "\"WEST_TOPDIR/motor/drivers/motor/common/common.c\"" "." "0"))) 
# 15 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
__attribute__((__aligned__(
# 15 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
4
# 15 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
))) 
# 15 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
_k_fifo_buf_can_tx_msgq[(4 * 2) * (sizeof(struct tx_frame))]; 
# 15 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
__attribute__((__aligned__(
# 15 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
...
# 15 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
struct k_msgq can_tx_msgq __attribute__((section("." "_k_msgq" "." "static" "." "can_tx_msgq_"))) __attribute__((__used__)) = { .wait_q = { { {(&(&can_tx_msgq.wait_q)->waitq)}, {(&(&can_tx_msgq.wait_q)->waitq)} } }, .lock = {}, .msg_size = (sizeof(struct tx_frame)), .max_msgs = (4 * 2), .buffer_start = _k_fifo_buf_can_tx_msgq, .buffer_end = _k_fifo_buf_can_tx_msgq + ((4 * 2) * (sizeof(struct tx_frame))), .read_ptr = _k_fifo_buf_can_tx_msgq, .write_ptr = _k_fifo_buf_can_tx_msgq, .used_msgs = 0, .flags = 0, };

static void can_tx_entry(void *arg1, void *arg2, void *arg3);
struct z_thread_stack_element __attribute__((section("." "noinit" "." "\"WEST_TOPDIR/motor/drivers/motor/common/common.c\"" "." "1"))) 
# 18 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
__attribute__((__aligned__(
# 18 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
8
# 18 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
))) 
# 18 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
_k_thread_stack_can_tx_thread[((((unsigned long)((((((unsigned long)(1024) + ((unsigned long)(8) - 1)) / (unsigned long)(8)) * (unsigned long)(8)) + ((size_t)0))) + ((unsigned long)(8) - 1)) / (unsigned long)(8)) * (unsigned long)(8))]; struct k_thread _k_thread_obj_can_tx_thread; 
# 18 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
__attribute__((__aligned__(
# 18 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
...
# 18 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
struct _static_thread_data _k_thread_data_can_tx_thread __attribute__((section("." "__static_thread_data" "." "static" "." "_k_thread_data_can_tx_thread_"))) __attribute__((__used__)) = { .init_thread = (&_k_thread_obj_can_tx_thread), .init_stack = (_k_thread_stack_can_tx_thread), .init_stack_size = (1024), .init_entry = (k_thread_entry_t)can_tx_entry, .init_p1 = (void *)
# 18 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
((void *)0)
# 18 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
, .init_p2 = (void *)
...
((void *)0)
# 18 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
, .init_prio = (0), .init_options = (0), .init_name = "can_tx_thread", .init_delay = { .ticks = ((0) == (-1) ? ((k_ticks_t) -1) : ((k_ticks_t)((
# 18 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
1
# 18 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
...
1
# 18 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
) ? (1000) - 1 : 0)) / (1000)) ))) } }; const k_tid_t can_tx_thread = (k_tid_t)&_k_thread_obj_can_tx_thread;

static 
# 20 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
      _Bool 
# 20 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
           initialized = 
# 20 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
                         0
# 20 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
...
int can_work_init(void)
{
 ...
 initialized = 
# 24 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
              1
# 24 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
                  ;
 return 0;
}
...
int8_t reg_can_dev(const struct device *dev)
{
 if (!initialized) {
  can_work_init();
  initialized = 
# 32 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
               1
# 32 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
                   ;
 }
 ...
 for (int i = 0; i < 2; i++) {
  if (can_devices[i] == 
# 39 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
                       ((void *)0)
# 39 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
                           ) {
...
int can_send_queued(const struct device *can_dev, struct can_frame *frame)
{
 if (!initialized) {
  return -
# 70 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
         88
# 70 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
               ;
 }

 int err = k_sem_take(&tx_queue_sem[get_can_id(can_dev)], ((k_timeout_t) {0}));
 if (err == 0) {
  err = can_send(can_dev, frame, ((k_timeout_t) {0}), can_tx_callback,
          &tx_queue_sem[get_can_id(can_dev)]);

  if (err) {
   do { if (!((1 && (((1) <= 0) || ((0 == 
# 79 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
  0
# 79 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
...
# 79 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
  ...
  err = k_msgq_put(&can_tx_msgq, &q_frame, ((k_timeout_t) {0}));
 }
...
void can_tx_entry(void *arg1, void *arg2, void *arg3)
{
 ...
 while (!k_msgq_get(&can_tx_msgq, &frame, ((k_timeout_t) { .ticks = (((k_ticks_t) -1)) }))) {

  err = k_sem_take(frame.sem, ((k_timeout_t) {0}));
  if (err == 0) {
   err = can_send(frame.can_dev, &(frame.frame), ((k_timeout_t) { .ticks = ((k_ticks_t)((
# 108 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
                                                1
# 108 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
...
# 108 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
                                                1
# 108 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
                                                ) ? (1000000) - 1 : 0)) / (1000000)) )) }), can_tx_callback,
           frame.sem);
   if (err && k_uptime_get() - last_time > 400) {
    do { if (!((1 && (((1) <= 0) || ((0 == 
# 111 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
   0
# 111 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
...
# 111 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
   ...
   if (failed_times > 127) {
    k_msgq_purge(&can_tx_msgq);
    do { if (!((1 && (((1) <= 0) || ((0 == 
# 118 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
   0
# 118 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
   ) && ((1) <= __log_level) && ((1) <= 4) ) )) && (0 || !0 || (1 <= ((const struct log_source_const_data *)__log_current_const_data)->level)) && (!0 || k_is_user_context() || ((1) <= ((*(&(((struct log_source_dynamic_data *)__log_current_const_data)->filters)) >> (3U * (0))) & ((1UL << (3U)) - 1U)))))) { break; } if (0) { do { z_log_minimal_printk("%c: " "Failed too many times, purge msgq" "\n", z_log_minimal_level_to_char(1)); } while (
# 118 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
   0
# 118 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
   ); break; } int _mode; 
...
# 118 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
   ((void *)0)
# 118 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
   ), (0), ((0 << 3) | (0 ? ((1UL << (1)) | (1UL << (0))) : 0)) | (0 ? (1UL << (6)) : 0), "Failed too many times, purge msgq"); (_mode) = Z_LOG_MSG_MODE_RUNTIME; } while (
# 118 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
   0
# 118 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
   ); (void)_mode; if (
# 118 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
   0
# 118 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
   ) { z_log_printf_arg_checker("Failed too many times, purge msgq"); } } while (
# 118 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
   0
# 118 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
   );
...
# 123 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
          1
# 123 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
          ) ? ( ((10000) == (1000000)) ? (uint64_t) ((((50) > (0)) ? (50) : (0))) : ((1000000) > (10000) && (1000000) % (10000) == 0U) ? (((uint64_t) ((((50) > (0)) ? (50) : (0))) + ((
# 123 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
          0
# 123 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
          ) ? ((1000000) / (10000)) / 2 : (
# 123 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
          1
# 123 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
          ) ? ((1000000) / (10000)) - 1 : 0)) / ((1000000)/(10000) ? (1000000)/(10000) : 01u)) : ((10000) > (1000000) && (10000) % (1000000) == 0U) ? (uint64_t) ((((50) > (0)) ? (50) : (0)))*((10000) / (1000000)) : ((((((365 * 24ULL * 3600ULL * 1000000) + (
# 123 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
          (0xffffffffUL)
# 123 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
          ) - 1) / (
...
# 123 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
          1
# 123 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
          ) ? (1000000) - 1 : 0)) / (1000000)) : (((uint64_t) ((((50) > (0)) ? (50) : (0))) / (1000000))*(10000) + (((uint64_t) ((((50) > (0)) ? (50) : (0))) % (1000000))*(10000) + ((
# 123 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
          0
# 123 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
          ) ? (1000000) / 2 : (
...
static const 
# 129 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
__attribute__((__aligned__(
# 129 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
__alignof(struct init_entry)
# 129 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
))) 
# 129 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
struct init_entry __attribute__((__section__( ".z_init_" "APPLICATION" "_P_" "90" "_SUB_" "0""_"))) __attribute__((__used__)) __init_can_work_init = {.init_fn = (can_work_init), .dev = 
# 129 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c" 3 4
((void *)0)
# 129 "/home/librgod/zephyr_workspace/motor/drivers/motor/common/common.c"
};
