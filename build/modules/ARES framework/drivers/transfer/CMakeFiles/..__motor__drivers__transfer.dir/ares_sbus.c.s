...
__log_level:
	.word	60
	.global	_k_mem_slab_buf_sbus_uart_slab
...
.LBB5:
	...
	cmp	r3, #0
	bne	.L83
	.loc 1 127 54 discriminator 2
	ldr	r3, [r7, #24]
	.loc 1 127 47 discriminator 2
	cmp	r3, #0
	beq	.L83
	.loc 1 128 4
	ldr	r3, [r7, #24]
...
.LBB7:
	...
	cmp	r3, #0
	beq	.L72
	.loc 1 148 34 discriminator 2
	ldr	r3, [r7, #20]
	.loc 1 148 49 discriminator 2
	and	r3, r3, #3
	.loc 1 148 30 discriminator 2
	cmp	r3, #0
	bne	.L72
	.loc 1 149 4
	ldr	r3, [r7, #20]
...
.LBB8:
	...
	cmp	r3, #0
	beq	.L85
	.loc 1 152 25 discriminator 3
	movs	r3, #1
	strb	r3, [r7, #59]
	.loc 1 152 10 discriminator 3
	ldrb	r3, [r7, #59]
	eor	r3, r3, #1
	uxtb	r3, r3
...
.LBB9:
	...
	cmp	r3, #0
	beq	.L87
	.loc 1 156 24 discriminator 3
	movs	r3, #1
	strb	r3, [r7, #51]
	.loc 1 156 9 discriminator 3
	ldrb	r3, [r7, #51]
	eor	r3, r3, #1
	uxtb	r3, r3
	.loc 1 156 8 discriminator 3
	cmp	r3, #0
	bne	.L88
	.loc 1 156 39 discriminator 4
	ldr	r3, .L89+4
	ldr	r1, [r3]
	ldr	r3, [r7, #60]
	str	r3, [sp, #12]
	...
	movs	r0, #0
	bl	z_log_msg_runtime_create
	.loc 1 156 137 discriminator 4
	movs	r3, #0
	str	r3, [r7, #44]
.LBE9:
	.loc 1 158 3 discriminator 4
	b	.L77
.L87:
.LBB10:
	.loc 1 156 307
...
.LBB13:
	...
	cmp	r3, #0
	beq	.L116
	.loc 1 172 23 discriminator 3
	movs	r3, #1
	strb	r3, [r7, #27]
	.loc 1 172 8 discriminator 3
	ldrb	r3, [r7, #27]
	eor	r3, r3, #1
	uxtb	r3, r3
	.loc 1 172 7 discriminator 3
	cmp	r3, #0
	bne	.L117
	.loc 1 172 38 discriminator 4
	ldr	r3, .L126+4
	ldr	r1, [r3]
	ldr	r3, .L126+8
	str	r3, [sp, #8]
...
.LBB15:
	...
	cmp	r3, #0
	beq	.L118
	.loc 1 185 23 discriminator 3
	movs	r3, #1
	strb	r3, [r7, #35]
	.loc 1 185 8 discriminator 3
	ldrb	r3, [r7, #35]
	eor	r3, r3, #1
	uxtb	r3, r3
	.loc 1 185 7 discriminator 3
	cmp	r3, #0
	bne	.L119
	.loc 1 185 38 discriminator 4
	ldr	r3, .L126+4
	ldr	r1, [r3]
	ldr	r3, [r7, #60]
	str	r3, [sp, #12]
...
.LBB17:
	...
	cmp	r3, #0
	beq	.L122
	.loc 1 205 23 discriminator 3
	movs	r3, #1
	strb	r3, [r7, #51]
	.loc 1 205 8 discriminator 3
	ldrb	r3, [r7, #51]
	eor	r3, r3, #1
	uxtb	r3, r3
	.loc 1 205 7 discriminator 3
	cmp	r3, #0
	bne	.L123
	.loc 1 205 38 discriminator 4
	ldr	r3, .L126+4
	ldr	r1, [r3]
	ldr	r3, [r7, #60]
	str	r3, [sp, #12]
...
sbus_api:
	...
	.section	.bss.sbus_data_0,"aw",%nobits
	.align	2
	.type	sbus_data_0, %object
	.size	sbus_data_0, 68
sbus_data_0:
	.space	68
	.section	.rodata.sbus_cfg_0,"a"
	.align	2
	.type	sbus_cfg_0, %object
	.size	sbus_cfg_0, 4
sbus_cfg_0:
	.byte	25
	.byte	16
...
__device_dts_ord_14:
	...
	.byte	0
	.space	3
	.section	.z_init_POST_KERNEL_P_90_SUB_00014_,"a"
	.align	2
...
.Letext0:
	...
	.file 14 "/home/librgod/zephyr_workspace/zephyr/include/zephyr/drivers/uart.h"
	.file 15 "/home/librgod/zephyr_workspace/motor/include/zephyr/drivers/sbus.h"
	.file 16 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.h"
	...
	.file 19 "/home/librgod/zephyr_workspace/zephyr/include/zephyr/fatal_types.h"
	.file 20 "/home/librgod/zephyr_workspace/zephyr/include/zephyr/sys_clock.h"
	.file 21 "/home/librgod/zephyr_workspace/zephyr/include/zephyr/logging/log_instance.h"
	.file 22 "/home/librgod/zephyr-sdk-0.17.0/arm-zephyr-eabi/picolibc/include/string.h"
	.file 23 "<built-in>"
	.file 24 "/home/librgod/zephyr_workspace/zephyr/include/zephyr/spinlock.h"
