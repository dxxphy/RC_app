...
char __attribute__((section("." "noinit" "." "\"WEST_TOPDIR/motor/drivers/transfer/ares_sbus.c\"" "." "k_mem_slab_buf_sbus_uart_slab"))) 
...
# 127 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c" 3 4
                                                       ((void *)0)
# 127 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
                                                           ) {
...
# 135 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
 ...
 case UART_RX_STOPPED: {
  uint8_t *buf = 
# 146 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c" 3 4
                ((void *)0)
# 146 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
                    ;
  err = k_mem_slab_alloc(&sbus_uart_slab, (void **)&buf, ((k_timeout_t) {0}));
  if (err == 0 && buf != 
# 148 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c" 3 4
                        ((void *)0) 
# 148 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
                             && ((uintptr_t)buf & 0x3) == 0) {
   memset(buf, 0, 64);
   err = uart_rx_enable(dev, buf, 64, 100);
   if (err) {
    do { if (!((1 && (((1) <= 0) || ((0 == 
# 152 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c" 3 4
   0
# 152 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
...
static int sbus_init(const struct device *dev)
{
 ...
 if (!device_is_ready(uart_dev)) {
  do { if (!((1 && (((1) <= 0) || ((0 == 
# 172 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c" 3 4
 0
# 172 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
...
# 172 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
  ...
  return -
# 173 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c" 3 4
         19
# 173 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
               ;
 }
 ...
 if (err) {
  do { if (!((1 && (((1) <= 0) || ((0 == 
# 185 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c" 3 4
 0
# 185 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
...
# 185 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
 ...
 if (err) {
  do { if (!((1 && (((1) <= 0) || ((0 == 
# 192 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c" 3 4
 0
# 192 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
 ) && ((1) <= __log_level) && ((1) <= 4) ) )) && (0 || !0 || (1 <= ((const struct log_source_const_data *)__log_current_const_data)->level)) && (!0 || k_is_user_context() || ((1) <= ((*(&(((struct log_source_dynamic_data *)__log_current_const_data)->filters)) >> (3U * (0))) & ((1UL << (3U)) - 1U)))))) { break; } if (0) { do { z_log_minimal_printk("%c: " "Failed to allocate memory: %d" "\n", z_log_minimal_level_to_char(1), err); } while (
# 192 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c" 3 4
 0
# 192 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
...
# 192 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
 ...
 if (err) {
  do { if (!((1 && (((1) <= 0) || ((0 == 
# 205 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c" 3 4
 0
# 205 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
...
# 205 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
 ...
 if (err) {
  do { if (!((1 && (((1) <= 0) || ((0 == 
# 215 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c" 3 4
 0
# 215 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
 ) && ((1) <= __log_level) && ((1) <= 4) ) )) && (0 || !0 || (1 <= ((const struct log_source_const_data *)__log_current_const_data)->level)) && (!0 || k_is_user_context() || ((1) <= ((*(&(((struct log_source_dynamic_data *)__log_current_const_data)->filters)) >> (3U * (0))) & ((1UL << (3U)) - 1U)))))) { break; } if (0) { do { z_log_minimal_printk("%c: " "Failed to enable RX: %d" "\n", z_log_minimal_level_to_char(1), err); } while (
# 215 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c" 3 4
 0
# 215 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
...
# 262 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
static struct sbus_driver_data sbus_data_0 = {0};; static const struct sbus_driver_config sbus_cfg_0 = { .startByte = 15, .endByte = 0, .frameSize = 25, .inputChannels = 16, };; static 
# 262 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c" 3 4
__attribute__((__aligned__(
# 262 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
...
# 262 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
struct device_state __devstate_dts_ord_14 __attribute__((__section__(".z_devstate"))); _Static_assert((sizeof("\"sbus0\"") <= 48U), "" "\"sbus0\"" " too long"); const 
# 262 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c" 3 4
__attribute__((__aligned__(
# 262 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
...
# 262 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
struct device __device_dts_ord_14 __attribute__((section("." "_device" "." "static" "." "3_90_"))) __attribute__((__used__)) = { .name = "sbus0", .config = (&sbus_cfg_0), .api = (&sbus_api), .state = (&__devstate_dts_ord_14), .data = (&sbus_data_0), .ops = { .init = (sbus_init), .deinit = (
# 262 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c" 3 4
((void *)0)
# 262 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
) }, .flags = ((0U * (1UL << (0)))), }; static const 
# 262 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c" 3 4
__attribute__((__aligned__(
# 262 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
...
# 262 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
struct init_entry __attribute__((__used__)) __attribute__((__section__( ".z_init_" "POST_KERNEL" "_P_" "90" "_SUB_" "00014""_"))) __init___device_dts_ord_14 = { .init_fn = 
# 262 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c" 3 4
((void *)0)
# 262 "/home/librgod/zephyr_workspace/motor/drivers/transfer/ares_sbus.c"
, .dev = (const struct device *)&__device_dts_ord_14, }; ;;
