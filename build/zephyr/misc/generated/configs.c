...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAIN_STACK_SIZE, 3200);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ARES_SBUS_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_DJI_MOTOR_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MOTOR_COMMON, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MOTOR_DJI, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MOTOR_DM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MOTOR_INIT_PRIORITY, 90);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CAN_COUNT, 2);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ARES_USB_BULK_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ARES_USB_THREAD_STACK_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ARES_UART_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ARES_UART_THREAD_STACK_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IMU_PWM_TEMP_CTRL, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AUTO_PROBE_GYRO_BIAS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_EKF_LIB, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PLOTTER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PLOTTER_FREQ, 800);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_ARES_FRAMEWORK_MODULE, 1);
